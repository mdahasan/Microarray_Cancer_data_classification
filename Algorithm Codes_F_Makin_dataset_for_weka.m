clear all;
%% Here the dataset is being created that will be used in Weka Tool
...
fid10 = fopen('10_features_database_weka.txt','w');
fid20 = fopen('20_features_database_weka.txt','w');
fid30 = fopen('30_features_database_weka.txt','w');
fid40 = fopen('40_features_database_weka.txt','w');
fid50 = fopen('50_features_database_weka.txt','w');
fid60 = fopen('60_features_database_weka.txt','w');
fid70 = fopen('70_features_database_weka.txt','w');
fid80 = fopen('80_features_database_weka.txt','w');
fid90 = fopen('90_features_database_weka.txt','w');
fid100 = fopen('100_features_database_weka.txt','w');
%fid150 = fopen('150_features_database_weka.txt','w');
%fid200 = fopen('200_features_database_weka.txt','w');
%fid300 = fopen('300_features_database_weka.txt','w');
%fid400 = fopen('400_features_database_weka.txt','w');
%fid500 = fopen('500_features_database_weka.txt','w');

% Making the database file for 10 features
for j = 1:rows_d
    for i = 1:10
        fprintf(fid10,'%d ',dataset(j,(features10(i))));    
    end
...
for j = 1:rows_d
    for i = 1:20
        fprintf(fid20,'%d ',dataset(j,(features20(i))));    
    end
...
for j = 1:rows_d
    for i = 1:30
        fprintf(fid30,'%d ',dataset(j,(features30(i))));    
    end
...
for j = 1:rows_d
    for i = 1:40
        fprintf(fid40,'%d ',dataset(j,(features40(i))));    
    end
...
for j = 1:rows_d
    for i = 1:50
        fprintf(fid50,'%d ',dataset(j,(features50(i))));    
    end
...
for j = 1:rows_d
    for i = 1:60
        fprintf(fid60,'%d ',dataset(j,(features60(i))));    
    end
...
for j = 1:rows_d
    for i = 1:70
        fprintf(fid70,'%d ',dataset(j,(features70(i))));    
    end
...
for j = 1:rows_d
    for i = 1:80
        fprintf(fid80,'%d ',dataset(j,(features80(i))));    
    end
...
for j = 1:rows_d
    for i = 1:90
        fprintf(fid90,'%d ',dataset(j,(features90(i))));    
    end
...
for j = 1:rows_d
    for i = 1:100
        fprintf(fid100,'%d ',dataset(j,(features100(i))));    
    end
...
%for j = 1:rows_d
%    for i = 1:150
%        fprintf(fid150,'%d ',dataset(j,(features150(i)+1)));    
%    end
...
%for j = 1:rows_d
%    for i = 1:200
%       fprintf(fid200,'%d ',dataset(j,(features200(i)+1)));    
%    end
...
% Making the database file for 300 features
%for j = 1:rows_d
%    for i = 1:300
%       fprintf(fid300,'%d ',dataset(j,features300(i)));    
%    end
%    fprintf(fid300,'%d',dataset(j,1));
%    fprintf(fid300,'\n');
%end
%fclose(fid300);

% Making the database file for 400 features
%for j = 1:rows_d
%    for i = 1:400
%        fprintf(fid400,'%d ',dataset(j,features400(i)));    
%    end
%    fprintf(fid400,'%d',dataset(j,1));
%    fprintf(fid400,'\n');
%end
%fclose(fid400);

% Making the database file for 500 features
%for j = 1:rows_d
%    for i = 1:500
%        fprintf(fid500,'%d ',dataset(j,features500(i)));    
%    end
%   fprintf(fid500,'%d',dataset(j,1));
%    fprintf(fid500,'\n');
%end
%fclose(fid500);
